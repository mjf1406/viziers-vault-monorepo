import { c as cr, R as R$1, T as T$1, h, p as pr, a as u, x as x$1, U } from "./main.js";
u();
var $ = "state.txt", G = "data", T = { DIR: 16384, FILE: 32768 }, H, v, F, M, y, b, m, x, P, D, S, n, C, O, k, w, f, I, W, j, L = class extends cr {
  ...
  async maintainPool(e) {
    ...
    for (let i = 0; i < t; i++) o.push(new Promise(async (c) => {
      ++this.poolCounter;
      let a = `${(Date.now() - 1704063600).toString(16).padStart(8, "0")}-${this.poolCounter.toString(16).padStart(8, "0")}`, h$1 = await h(this, F).getFileHandle(a, { create: true }), d = await h$1.createSyncAccessHandle();
      h(this, b).set(a, h$1), h(this, m).set(a, d), T$1(this, n, k).call(this, { opp: "createPoolFile", args: [a] }), this.state.pool.push(a), c();
    }));
    for (let i = 0; i > t; i--) o.push(new Promise(async (c) => {
      let a = this.state.pool.pop();
      T$1(this, n, k).call(this, { opp: "deletePoolFile", args: [a] });
  ...
  chmod(e, t) {
    T$1(this, n, O).call(this, { opp: "chmod", args: [e, t] }, () => {
  ...
  mkdir(e, t) {
    T$1(this, n, O).call(this, { opp: "mkdir", args: [e, t] }, () => {
  ...
  _mkdirState(e, t) {
    ...
    let h2 = { type: "directory", lastModified: Date.now(), mode: t?.mode || T.DIR, children: {} };
    a.children[i] = h2;
  }
  open(e, t, o) {
  ...
  read(e, t, o, i, c) {
    let a = T$1(this, n, I).call(this, e), h$1 = T$1(this, n, f).call(this, a);
  ...
  rename(e, t) {
    T$1(this, n, O).call(this, { opp: "rename", args: [e, t] }, () => {
  ...
  _renameState(e, t, o = false) {
    ...
    let h$1 = T$1(this, n, w).call(this, t), d = h$1.pop(), l = T$1(this, n, f).call(this, h$1.join("/"));
  ...
  rmdir(e) {
    T$1(this, n, O).call(this, { opp: "rmdir", args: [e] }, () => {
      this._rmdirState(e);
    });
  }
  _rmdirState(e) {
  ...
  unlink(e) {
    T$1(this, n, O).call(this, { opp: "unlink", args: [e] }, () => {
  ...
  utimes(e, t, o) {
    T$1(this, n, O).call(this, { opp: "utimes", args: [e, t, o] }, () => {
  ...
  writeFile(e, t, o) {
    ...
    if (Object.prototype.hasOwnProperty.call(a.children, c)) {
      let l = a.children[c];
      l.lastModified = Date.now(), T$1(this, n, k).call(this, { opp: "setLastModified", args: [e, l.lastModified] });
    } else {
      if (this.state.pool.length === 0) throw new Error("No more file handles available in the pool");
      let l = { type: "file", lastModified: Date.now(), mode: o?.mode || T.FILE, backingFilename: this.state.pool.pop() };
      a.children[c] = l, T$1(this, n, k).call(this, { opp: "createFileNode", args: [e, l] });
    }
...
H = /* @__PURE__ */ new WeakMap(), v = /* @__PURE__ */ new WeakMap(), F = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap(), y = /* @__PURE__ */ new WeakMap(), b = /* @__PURE__ */ new WeakMap(), m = /* @__PURE__ */ new WeakMap(), x = /* @__PURE__ */ new WeakMap(), P = /* @__PURE__ */ new WeakMap(), D = /* @__PURE__ */ new WeakMap(), S = /* @__PURE__ */ new WeakMap(), n = /* @__PURE__ */ new WeakSet(), C = async function() {
  x$1(this, H, await navigator.storage.getDirectory()), x$1(this, v, await T$1(this, n, j).call(this, this.dataDir, { create: true })), x$1(this, F, await T$1(this, n, j).call(this, G, { from: h(this, v), create: true })), x$1(this, M, await h(this, v).getFileHandle($, { create: true })), x$1(this, y, await h(this, M).createSyncAccessHandle());
...
`), i = false;
  try {
    ...
    t = { root: { type: "directory", lastModified: Date.now(), mode: T.DIR, children: {} }, pool: [] }, h(this, y).truncate(0), h(this, y).write(new TextEncoder().encode(JSON.stringify(t)), { at: 0 }), i = true;
  }
  this.state = t;
  ...
  let a = [], h$1 = async (l) => {
    ...
    else for (let u2 of Object.values(l.children)) a.push(h$1(u2));
  };
